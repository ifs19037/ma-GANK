            ...
            <body class=" layout-fluid"> 
                ...
                <div class="mdk-header-layout js-mdk-header-layout">
                    ...
                    <div class="mdk-header-layout__content">
                                    ...
                                    <div class="sidebar sidebar-left sidebar-dark bg-dark o-hidden" data-perfect-scrollbar>
                                        <div class="sidebar-p-y">
                                            ...
                                            <ul class="sidebar-menu sm-active-button-bg">
                                                ...
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button sidebar-js-collapse" data-toggle="collapse" href="#manajemen_pelatihan">
                                                        <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">person_outline</i> Account
                                                        <span class="ml-auto sidebar-menu-toggle-icon"></span>
                                                    </a>
                                                    <ul class="sidebar-submenu sm-indent collapse" id="manajemen_pelatihan">
                                                        <li class="sidebar-menu-item">
                        ...
                        <!-- App Settings FAB -->
                        <div id="app-settings">
                            <app-settings layout-active="default" :layout-location="{ 'fixed': '{{ URL::asset('asset/LearnPlus/learnplus.demo.frontendmatter.com/instructor-dashboard.html') }}' }" sidebar-variant="bg-transparent border-0"></app-settings>
                        </div>
                        ...
                        @csrf
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input name="nik" id="nik" type="text" required class="form-control form-control-prepended" data-mask="###" data-mask-reverse="true">
