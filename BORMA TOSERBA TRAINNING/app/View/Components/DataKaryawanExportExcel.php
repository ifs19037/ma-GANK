...
{
    public function __construct($nama_karyawan, $nik, $jenis_kelamin, $jabatan, $divisi, $lokasi, $tanggal_lahir, $tanggal_masuk, $email, $no_telepon, $alamat_ktp)
    {
    ...
    {   
        return view('data_karyawan_export_excel', [
            'DataKaryawanExportExcel' => DataKaryawan::where('nama_karyawan','like', '%'.$this->nama_karyawan.'%')->where('nik', 'like', '%'.$this->nik.'%')
